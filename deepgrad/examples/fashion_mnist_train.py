...
TRAIN_CSV = 'deepgrad/examples/datasets/fashion_mnist_train.csv'
TEST_CSV = 'deepgrad/examples/datasets/fashion_mnist_test.csv'

# --- Data Utilities ---
def convert_csv_to_bin(csv_path, bin_path, normalize=False):
    MEAN, STD = 0.2860406, 0.3530242
...
def main():
    ...
    executor.shutdown()
    with open('deepgrad/examples/fashion_model.pkl', 'wb') as f:
        dill.dump(model, f)
